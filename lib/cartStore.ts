...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'hot-spicy',
    name: 'Hot & Spicy Herb Blend',
    price: 2.99,
    size: '30g',
    image: '/pro2.png',
    badge: 'Popular',
    description: 'Bold heat meets balanced flavor for those who love the fire.',
    benefits: ['Salt-Free', 'Non-GMO', 'MSG-Free'],
  },
  {
    id: 'chili-cayenne',
    name: 'Chili & Cayenne Blend',
    price: 2.99,
    size: '30g',
    image: '/pro3.png',
  ...
  {
    id: 'red-onion-dried',
    name: 'Red Onion Dried',
    price: 1.99,
    size: '30g',
    image: '/pro8.png',
    description: 'Pure, clean, dried red onion with intense flavor.',
